			...
			<div class="container text-center">
				<div style="padding-top:20px">
					<table class="table table-hover" style="text-align:center">
						...
						<tr>
							<td><%=(start+i) %></td>
							<td><a href="AdminBoard.do?num=<%=board.get(i).getNum() %>" class="text-decoration-none"><%=board.get(i).getTitle() %></a></td>
						...
						<tr>
							<td><%=(start+i) %></td>
							<td><a href="AdminBoard.do?num=<%=searchboard.get(i).getNum() %>" class="text-decoration-none"><%=searchboard.get(i).getTitle() %></a></td>
