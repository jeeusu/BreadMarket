	...
	<div class="container py-4">
	    ...
	    <div class="row align-items-md-stretch">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-3">
					<input type="text" name="bname" id="bname" placeholder="<%=rs.getString("bname") %>">
				</div>
			</div>
			<div class="mb-3 row">
				<label class="col-sm-2">가격 :</label>
				<div class="col-sm-3">
					<input type="text" name="price" id="price" placeholder="<%=rs.getString("price") %>">
				</div>
			</div>
			<div class="mb-3 row">
				<label class="col-sm-2">상세 정보 :</label>
				<div class="col-sm-3">
					<textarea name="info" id="info" cols="50" rows="5" placeholder="<%=rs.getString("info") %>"></textarea>
				</div>
			</div>
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-3">
					<input type="text" name="eatbydate" placeholder="<%=rs.getString("eatbydate") %>">
				</div>
			</div>
			<div class="mb-3 row">
				<label class="col-sm-2">배송비 :</label>
				<div class="col-sm-3">
					<input type="text" name="delivery" placeholder="<%=rs.getString("delivery") %>">
				</div>
			</div>
			<div class="mb-3 row">
				<label class="col-sm-2">알레르기 정보 :</label>
				<div class="col-sm-3">
					<input type="text" name="allergy" placeholder="<%=rs.getString("allergy") %>">
				</div>
			</div>
			<div class="mb-3 row">
