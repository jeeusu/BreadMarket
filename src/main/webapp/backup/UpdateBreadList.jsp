...
<body>
	<div class="container py-4">
		...
		<a href="AddBread.jsp" class="btn btn-secondary" role="button">메뉴 등록&raquo;</a>
			...
			<div class="col-md-4">
	        	<div class="h-100 p-2">
		        	<img src="/images/<%=rs.getString("img")%>" width="150px"/>	
		 			...
		 			<p> <a href="UpdateBread.jsp?id=<%=rs.getString("bname")%>" class="btn btn-secondary" role="button">메뉴 수정&raquo;</a>
		 			 <a href="DeleteBread.jsp?id=<%=rs.getString("bname")%>" class="btn btn-secondary" role="button">메뉴 삭제&raquo;</a>
	 			</div>
	 		</div>
	 		<%
	 			}
