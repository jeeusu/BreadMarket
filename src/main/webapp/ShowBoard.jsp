	...
	<div class="container py-4">
		...
		<div class="row">
			...
			%>
				<table width="100%">
					<tr>
						<td align="left"><a href="UpdateBoard.jsp?num=<%=num %>" class="btn btn-success">수정하기</a></td>
						<td align="right"><a href="DeleteBoard.do?num=<%=num %>" class="btn btn-danger">삭제하기</a></td>
					</tr>
				</table>
