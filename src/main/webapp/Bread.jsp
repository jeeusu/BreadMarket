			...
			<%
				...
				if(complete!=null) {
					if(complete.equals("complete")) {
						...
						out.println("장바구니 추가 완료");
						out.println("</div>");
					}
				}
				
				String amount="";
			 	String sql = "select bname, price, info, eatbydate, delivery, allergy, img, amount from bread where bname=? ";
			...
			<div class="bread">	
				<div class="row">
				    ...
				    <div class="col align-content-center" id="information">
						...
						<p><b>수량 :</b> <%=rs.getString("amount") %>개 남음 </p> 
						...
						<button type="button" class="btn btn-outline-secondary">주문불가</button>
						<%} else {%>
